...
namespace modulos
{
    ...
    public class cls_consultas_Mysql
    {
        ...
        public DataTable consultar_cuenta_por_pagar_por_id(string id_remito)
        {
            cls_conexion base_datos = new cls_conexion(servidor, puerto, usuario, password, base_de_datos);
            DataTable retorno;
            string query;
            ...
            try
            {
                query = "SELECT * FROM " + base_de_datos + ".cuenta_por_pagar where activa=1 and id='" + id_remito + "'";
                retorno = base_datos.READ(query);
            }
            catch (Exception ex)
            {
        ...
        public DataTable consultar_sucursal_por_id(string id)
        {
            cls_conexion base_datos = new cls_conexion(servidor, puerto, usuario, password, base_de_datos);
            DataTable retorno;
            string query;
            ...
            try
            {
                query = "SELECT * FROM " + base_de_datos + ".sucursal where  activa=1 and id='" + id + "'";
                retorno = base_datos.READ(query);
            }
            catch (Exception ex)
            {
