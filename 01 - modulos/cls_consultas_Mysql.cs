...
namespace modulos
{
    ...
    public class cls_consultas_Mysql
    {
        ...
        public DataTable consultar_historial_evaluacion_chequeo_segun_fecha_solamente(string año, string mes, string dia)
        {
            cls_conexion base_datos = new cls_conexion(servidor, puerto, usuario, password, base_de_datos);
            DataTable retorno;
            string query;
            ...
            try
            {
                query = "SELECT * FROM " + base_de_datos + ".historial_evaluacion_chequeo WHERE activa=1 and YEAR(fecha)='" + año + "' and MONTH(fecha)='" + mes + "' and DAY(fecha)='" + dia + "';";
        ...
        public DataTable consultar_historial_evaluacion_chequeo_segun_mes_y_año(string año, string mes,string id_sucursal)
        {
            ...
            try
            {
                query = "SELECT * FROM " + base_de_datos + ".historial_evaluacion_chequeo WHERE activa=1 and id_sucursal='" + id_sucursal + "' and YEAR(fecha)='" + año + "' and MONTH(fecha)='" + mes + "';";
        ...
        public DataTable consultar_solicitud_franquicia_segun_fecha(string mes, string año)
        {
            cls_conexion base_datos = new cls_conexion(servidor, puerto, usuario, password, base_de_datos);
            DataTable retorno;
            string query;
            ...
            try
            {
                query = "SELECT * FROM " + base_de_datos + ".solicitud_franquicia WHERE activa=1 and YEAR(fecha)='" + año + "' and MONTH(fecha)='" + mes + "';";
        ...
        public DataTable consultar_solicitud_franquicia_por_id(string id)
        {
            cls_conexion base_datos = new cls_conexion(servidor, puerto, usuario, password, base_de_datos);
            DataTable retorno;
            string query;
            ...
            try
            {
                query = "SELECT * FROM " + base_de_datos + ".solicitud_franquicia WHERE activa=1 and id='" + id + "';";
        ...
        public DataTable consultar_tickets_abiertos()
        {
            cls_conexion base_datos = new cls_conexion(servidor, puerto, usuario, password, base_de_datos);
            DataTable retorno;
            string query;
            ...
            try
            {
                query = "SELECT * FROM " + base_de_datos + ".tickets WHERE activa=1 and estado='abierto';";
        ...
        public DataTable consultar_tickets_segun_fecha(string mes, string año,string tipo_ticket)
        {
            ...
            try
            {
                query = "SELECT * FROM " + base_de_datos + ".tickets WHERE activa=1 and tipo_ticket='" + tipo_ticket + "' and YEAR(fecha_solicitud)='" + año + "' and MONTH(fecha_solicitud)='" + mes + "';";
        ...
        public DataTable consultar_tickets_abiertos(string tipo_ticket)
        {
            cls_conexion base_datos = new cls_conexion(servidor, puerto, usuario, password, base_de_datos);
            DataTable retorno;
            string query;
            ...
            try
            {
                query = "SELECT * FROM " + base_de_datos + ".tickets WHERE activa=1 and tipo_ticket='" + tipo_ticket + "' and estado='abierto' ;";
