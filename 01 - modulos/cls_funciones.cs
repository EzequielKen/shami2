...
namespace paginaWeb
{
    ...
    public class cls_funciones
    {
        ...
        public int buscar_fila_por_dato_en_columna(string dato, string columna, DataTable dt)
        {
            int retorno = -1;
            int fila = 0;
            while (fila <= dt.Rows.Count - 1)
        ...
        public bool verificar_si_cargo_dato(string dato,string columna, DataTable dt)
        {
            bool retorno = false;
            int fila = 0;
            while (fila <= dt.Rows.Count - 1)
