...
namespace _03___sistemas_fabrica
{
    public class cls_historial_de_produccion
    {
        ...
        private void consultar_todo_historial_de_produccion()
        {
        ...
        public DataTable get_todo_historial_de_produccion()
        {
            consultar_todo_historial_de_produccion();
        ...
        public void crear_pdf_historial_produccion(string ruta, byte[] logo, string id_historial, string nombre_proveedor)
        {
            ...
            int fila_historial = buscar_fila_historial_por_id(id_historial, historial_produccion_proveedor_cliente);
            abrir_pedido(fila_historial, historial_produccion_proveedor_cliente);
            PDF.GenerarPDF_historial_produccion(ruta, logo, fila_historial, historial_produccion_proveedor_cliente, resumen_pedido);
        }
