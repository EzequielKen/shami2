    ...
    public class cls_temperatura_de_equipos
    {
        ...
        private void ordenar_temperatura()
        {
            ...
            for (int fila = 0; fila <= equipos.Rows.Count-1; fila++)
            {
                ...
                if (rango == "rango 2")
                {
                    temperaturas.Rows[ult_fila]["turno_2"] = temperaturas_del_dia.Rows[fila_temperatura]["temperatura"].ToString();
                }
                else
                {
                ...
                if (rango == "rango 3")
                {
                    temperaturas.Rows[ult_fila]["turno_3"] = temperaturas_del_dia.Rows[fila_temperatura]["temperatura"].ToString();
                }
                else
                {
