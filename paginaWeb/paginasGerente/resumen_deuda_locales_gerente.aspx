<%@ Page Title="" Language="C#" MasterPageFile="~/paginasMaestras/paginaMaestraGerente.Master" AutoEventWireup="true" CodeBehind="resumen_deuda_locales_gerente.aspx.cs" Inherits="paginaWeb.paginasGerente.resumen_deuda_locales_gerente" %>
                        ...
                        <div class="alert alert-light">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <asp:DropDownList ID="dropDown_mes" runat="server" OnSelectedIndexChanged="dropDown_mes_SelectedIndexChanged" CssClass="form-select" AutoPostBack="true">
                                    </asp:DropDownList>
                                </div>
                                <div class="col">
                                    <asp:Label Text="Año" CssClass=" form-label" runat="server" />
                                    <asp:DropDownList ID="dropDown_año" runat="server" OnSelectedIndexChanged="dropDown_año_SelectedIndexChanged" CssClass="form-select" AutoPostBack="true">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="alert alert-light">
                            ...
                            <asp:GridView ID="gridView_remitos" runat="server" Caption="REMITOS" CaptionAlign="Top" AutoGenerateColumns="false" CssClass="table table-striped table table-dark table-striped" OnSelectedIndexChanged="gridView_remitos_SelectedIndexChanged" OnRowDataBound="gridView_remitos_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Aplicar IVA" Visible="false">
                                        <ItemTemplate>
                                        ...
                                        <div class="col">
                                            <div class="alert alert-light">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <asp:Label Text="Detalle" CssClass=" form-label" runat="server" />
                                                        <asp:TextBox ID="textBox_detalle" CssClass="form-control" runat="server" />
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <asp:Label Text="Monto" CssClass=" form-label" runat="server" />
