...
{
    public partial class orden_de_pedido_fabrica_fatay : System.Web.UI.Page
    {
        ...
        private void llenar_dropDownList(DataTable dt)
        {
            ...
            item = new ListItem("7-Lacteos", num_item.ToString());
            dropDown_tipo.Items.Add(item);
            num_item = num_item + 1;
            item = new ListItem("14-Frutas y Verduras", num_item.ToString());
            dropDown_tipo.Items.Add(item);
            num_item = num_item + 1;
        }
