...
{
    public partial class importar_produccion : System.Web.UI.Page
    {
        ...
        ///////////////////////////////////////////////////////////////////////////
        cls_recepcion_de_produccion recepcion;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Session.Add("recepcion", new cls_recepcion_de_produccion(usuariosBD));
            }
            recepcion = (cls_recepcion_de_produccion)Session["recepcion"];
        ...
        protected void boton_enviar_Click1(object sender, EventArgs e)
        {
            ...
            Response.Redirect("/paginasFabrica/historial_de_produccion.aspx", false);
        }
    }
}