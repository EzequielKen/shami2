...
{
    public partial class analisis_de_produccion : System.Web.UI.Page
    {
        ...
        protected void boton_calcular_Click(object sender, EventArgs e)
        {
                ...
                Session["fecha_estadistica_fin"].ToString() != "N/A")
            {
                ...
                estadisticas_de_pedidos_seleccionados = estadisticas.get_analisis_produccion(Session["fecha_estadistica_inicio"].ToString(), Session["fecha_estadistica_fin"].ToString());
