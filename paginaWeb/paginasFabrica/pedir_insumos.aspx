<%@ Page Async="true"  Title="" Language="C#" MasterPageFile="~/paginasMaestras/paginaMaestraFabrica.Master" AutoEventWireup="true" CodeBehind="pedir_insumos.aspx.cs" Inherits="paginaWeb.paginasFabrica.pedir_insumos" %>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <asp:GridView Caption="LISTA DE PRODUCTOS" CaptionAlign="Top" OnSelectedIndexChanged="gridview_productos_SelectedIndexChanged" runat="server" ID="gridview_productos" AutoGenerateColumns="false" CssClass="table table-dark table-striped">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Medida" DataField="unidad_medida" />
