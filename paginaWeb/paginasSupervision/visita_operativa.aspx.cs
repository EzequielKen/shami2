...
{
    public partial class visita_operativa1 : System.Web.UI.Page
    {
        ...
        private void modificar_cargo(string id_empleado, string cargo)
        {
            ...
            {
                visita.actualizar_cargos_empleado(id_empleado, lista_de_empleadoBD);
        ...
        protected void textbox_nombre_empleado_TextChanged(object sender, EventArgs e)
        {
            ...
            visita.actualizar_dato_empleado(id, campo, dato);
            lista_de_empleadoBD = visita.get_lista_de_empleado(usuariosBD.Rows[0]["sucursal"].ToString(), fecha_de_hoy);
            configurar_controles();
            cargar_lista_empleados();
        }
        ...
        protected void boton_eliminar_Click(object sender, EventArgs e)
        {
            ...
            int rowIndex = row.RowIndex;
            visita.desloguear_empleado(gridview_empleados.Rows[rowIndex].Cells[0].Text);
            lista_de_empleadoBD = visita.get_lista_de_empleado(usuariosBD.Rows[0]["sucursal"].ToString(), fecha_de_hoy);
            configurar_controles();
            cargar_lista_empleados();
        }
