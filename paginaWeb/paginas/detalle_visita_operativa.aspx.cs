...
{
    public partial class detalle_visita_operativa : System.Web.UI.Page
    {
        ...
        private void primeras_ejecuciones()
        {
            ...
            {
                label_observacion.Text = observaciones.Rows[0]["observacion"].ToString();

            }
            else
            {
                label_observacion.Text = "";
            }
        ...
        {
            DateTime fecha = DateTime.Parse(Session["fecha_historial_visita"].ToString());
        ...
        protected void boton_pdf_Click(object sender, EventArgs e)
        {
            ...
            observacion = label_observacion.Text;
