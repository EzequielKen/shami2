<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/paginasMaestras/paginaMaestraSistema.Master" AutoEventWireup="true" CodeBehind="asignador_de_cargos.aspx.cs" Inherits="paginaWeb.paginas.administrador_de_empleados" %>
                            ...
                            <asp:GridView Caption="LISTA DE EMPLEADOS" CaptionAlign="Top" runat="server" ID="gridview_empleados" AutoGenerateColumns="false" CssClass="table table-dark   table-striped" OnRowDataBound="gridview_empleados_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Desloguear">
                                        <ItemTemplate>
                                            <asp:Button ID="boton_eliminar" CssClass="btn btn-danger" Text="Desloguear" runat="server" OnClick="boton_eliminar_Click" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
