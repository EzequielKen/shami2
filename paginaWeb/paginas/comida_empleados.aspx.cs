...
{
    public partial class comida_empleados : System.Web.UI.Page
    {
        ...
        protected void boton_cargar_comida_Click(object sender, EventArgs e)
        {
            Button boton = (Button)sender;
            GridViewRow row = (GridViewRow)boton.NamingContainer;
            int rowIndex = row.RowIndex;
            string id_empleado = gridview_empleados.Rows[rowIndex].Cells[0].Text;
            Session.Add("id_empleado", id_empleado);

            string nombre_empleado = gridview_empleados.Rows[rowIndex].Cells[1].Text;
            Session.Add("nombre_empleado", nombre_empleado);

            string apellido_empleado = gridview_empleados.Rows[rowIndex].Cells[2].Text;
            Session.Add("apellido_empleado", apellido_empleado);

            Response.Redirect("~/paginas/registro_comida_empleado.aspx",false);
        }
    }
}