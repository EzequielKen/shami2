            ...
            <div class=" container-fluid">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <h2>
                            <asp:Label ID="label_total_encargado" Text="text" runat="server" />
                        </h2>
                        <h2>
                            <asp:Label ID="label_total_cajeros" Text="text" runat="server" />
                        </h2>
                        <h2>
                            <asp:Label ID="label_total_shawarmero" Text="text" runat="server" />
                        </h2>
                        <h2>
                            <asp:Label ID="label_total_atencion_al_cliente" Text="text" runat="server" />
                        </h2>
                        <h2>
                            <asp:Label ID="label_total_cocina" Text="text" runat="server" />
                        </h2>
                        <h2>
                            <asp:Label ID="label_total_limpieza" Text="text" runat="server" />
                        </h2>
                    </div>
                    <h4 class="pt-4">
