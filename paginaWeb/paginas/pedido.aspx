<%@ Page Async="true" Title="" Language="C#" MasterPageFile="/paginasMaestras/paginaMaestraSistema.Master" AutoEventWireup="true" CodeBehind="pedido.aspx.cs" Inherits="paginaWeb.pedido" %>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="row alert alert-light">
                            <asp:Button Text="Lista de precios PDF" ID="Button_lista_de_precios" runat="server" CssClass="btn btn-primary btn-sm" OnClick="Button_lista_de_precios_Click" />
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="row alert alert-light">
                            <asp:TextBox ID="textbox_nota" placeholder="Ingrese una nota" runat="server" />
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="row alert alert-light">
