...
namespace _05___sistemas_fabrica_fatay
{
    public class cls_stock_producto_terminado_fabrica_fatay
    {
        ...
        private void cargar_historial_stock(string rol_usuario, string id_producto, string tipo_movimiento, string stock_inicial, string movimiento, string stock_final, string nota)
        {
            ...
            consultas.insertar_en_tabla(base_de_datos, "stock_producto_terminado_fabrica_fatay", columnas, valores);
        }
        #endregion
        ...
        {
            historial_stock = consultas.consultar_stock_producto_terminado_fabrica_fatay_segun_producto(id_producto);
        }
