...
namespace _05___sistemas_fabrica_fatay
{
    ...
    public class cls_stock_insumos_fabrica_fatay
    {
        ...
        public void guardar_registro_entrega_insumo(string rol_usuario, DataTable insumos, DataTable insumos_copia)
        {
            ...
            guardar_registro_conteo_de_stock_entrega_insumo(rol_usuario, insumos, insumos_copia, "despacho insumo expredicion a produccion");
        }
        ...
        private void actualizar_stock_insumo(int fila, DataTable insumos)
        {
            ...
            for (int columna = insumos.Columns["producto_1"].Ordinal; columna <= insumos.Columns.Count - 1; columna++)
            {
                ...
                else
                {
                    ...
                    consultas.actualizar_tabla(base_de_datos, "insumos_fabrica_fatay", actualizar, id);
                }
            }
        }
        #endregion
