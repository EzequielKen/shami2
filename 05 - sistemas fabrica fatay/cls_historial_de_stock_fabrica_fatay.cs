...
{
    public class cls_historial_de_stock_fabrica_fatay
    {
        public cls_historial_de_stock_fabrica_fatay(DataTable usuario_BD)
        {
            ...
            stock_Producto_Terminado_fabrica_fatay = new cls_stock_producto_terminado_fabrica_fatay(usuario_BD);
        }

        #region atributos
        cls_stock_producto_terminado_fabrica_fatay stock_Producto_Terminado_fabrica_fatay;
        ...
        */
        ...
        {
            stock_Producto_Terminado_fabrica_fatay.cargar_historial_stock(rol_usuario, id_producto, tipo_movimiento, movimiento, nota);
        }
        ...
        private void consultar_productos_proveedor()
        {
            ...
            string id, unidad_de_medida_produccion;
            for (int fila = 0; fila <= productos_proveedor.Rows.Count - 1; fila++)
            {
                id = productos_proveedor.Rows[fila]["id"].ToString();
                unidad_de_medida_produccion = productos_proveedor.Rows[fila]["unidad_de_medida_produccion"].ToString();
                productos_proveedor.Rows[fila]["ultimo_stock"] = stock_Producto_Terminado_fabrica_fatay.get_ultimo_stock_producto_terminado(id) + " " + unidad_de_medida_produccion;
            }
        }
        private void consultar_historial_producto(string id_producto, string mes, string año)
        {
            historial_producto = consultas.consultar_historial_producto_segun_mes_y_año(base_de_datos, "stock_producto_terminado_fabrica_fatay", id_producto, mes, año);
        }
        #endregion
